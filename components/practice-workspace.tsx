...
export function PracticeWorkspace({ initialMode = "cn2en" }: { initialMode?: PracticeMode }) {
  ...
  async function submit() {
    ...
    setSubmitting(true); setError(""); setFeedback(correct ? "回答正确，正在保存..." : `再看一眼：${card.term} · 正在保存...`); setPhase("feedback");
